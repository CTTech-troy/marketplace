...
// 2) individual env fields (preferred)
...
// 3) Fallback to local file serviceAccountKey.json
...
const projectId = (serviceAccount && serviceAccount.project_id) || "cttech-c3806";

if (!serviceAccount) {
  console.warn('No Firebase service account found. Using application default credentials if available.');
}
